                        ...
                        (e.svg = !(e.vml = "VML" == e.type)),
                            ...
                            (e.is = function (t, e) {
                                return "finite" == (e = b.call(e))
                                    ...
                                    : "array" == e
                                    ? t instanceof Array
                                    : ("null" == e && null === t) || (e == typeof t && null !== t) || ("object" == e && t === Object(t)) || ("array" == e && Array.isArray && Array.isArray(t)) || M.call(t).slice(8, -1).toLowerCase() == e;
                            }),
                        ...
                        (e.color = function (t) {
                            ...
                            (e.rgb2hsb = function (t, e, r) {
                                ...
                                return (
                                    ...
                                    (e = r[1]),
                                    (r = r[2]),
                                    { h: ((((0 == (n = (i = w(t, e, r)) - k(t, e, r)) ? null : i == t ? (e - r) / n : i == e ? (r - t) / n + 2 : (t - e) / n + 4) + 360) % 6) * 60) / 360, s: 0 == n ? 0 : n / i, b: i, toString: nt }
                                );
                            }),
                            (e.rgb2hsl = function (t, e, r) {
                                ...
                                return (
                                    ...
                                    { h: ((((0 == (s = n - a) ? null : n == t ? (e - r) / s : n == e ? (r - t) / s + 2 : (t - e) / s + 4) + 360) % 6) * 60) / 360, s: 0 == s ? 0 : i < 0.5 ? s / (2 * i) : s / (2 - 2 * i), l: i, toString: at }
                                );
                            }),
                            ...
                            (Wt.getBBox = function (t) {
                                ...
                                return t
                                    ...
                                    : ((e.dirty || e.dirtyT || !e.bbox) &&
                                          ((!e.dirty && this.realPath) || ((e.bboxwt = 0), (this.realPath = Z[this.type](this))), (e.bbox = yt(Q(this.realPath, this.matrix))), (e.bbox.toString = Ht), (e.dirty = e.dirtyT = 0)),
                                      e.bbox);
                            }),
                            (Wt.clone = function () {
                        ...
                        if (!t || t.svg) {
                            ...
                            var x = function (i, n) {
                                    ...
                                    if (!m) {
                                        ...
                                        if (((u = u.replace(/[\(\)\s,\xb0#]/g, "_")), e.gradient && u != e.gradient.id && (g.defs.removeChild(e.gradient), delete e.gradient), !e.gradient)) {
                                            ...
                                            for (var B = 0, C = k.length; B < C; B++)
                                                m.appendChild(x("stop", { offset: k[B].offset ? k[B].offset : B ? "100%" : "0%", "stop-color": k[B].color || "#fff", "stop-opacity": isFinite(k[B].opacity) ? k[B].opacity : 1 }));
                                        }
                                    }
                                ...
                                b = function (i, n, a) {
                                    if ("path" == i.type) {
                                        for (
                                            var s, o, l, h, u, f = r(n).toLowerCase().split("-"), p = i.paper, v = a ? "end" : "start", y = i.node, m = i.attrs, b = m["stroke-width"], _ = f.length, w = "classic", k = 3, B = 3, C = 5;
                                            _--;
                            ...
                            (S.prototype = T),
                                ...
                                (T.transform = function (r) {
                                    ...
                                    if (
                                        (t._extractTransform(this, r), this.clip && x(this.clip, { transform: this.matrix.invert() }), this.pattern && m(this), this.node && x(this.node, { transform: this.matrix }), 1 != i.sx || 1 != i.sy)
                                    ) {
                                        ...
                                        if ((!(j = j && j[0]) && (j = k("fill")), "image" == n.type && l.src && (j.src = l.src), l.fill && (j.on = !0), (null != j.on && "none" != l.fill && null !== l.fill) || (j.on = !1), j.on && l.fill)) {
                                            ...
                                            if (I) {
                                                ...
                                                (j.color = t.getRGB(l.fill).hex),
                                                    (j.src = f),
                                                    (j.type = "solid"),
                                                    t.getRGB(l.fill).error && (T.type in { circle: 1, ellipse: 1 } || "r" != r(l.fill).charAt()) && S(T, l.fill, j) && ((g.fill = "none"), (g.gradient = l.fill), (j.rotate = !1));
                                        }
                                ...
                                S = function (e, a, s) {
                                    ...
                                    if (
                                        ...
                                        (a = (a = r(a).replace(t._radial_gradient, function (t, e, r) {
                                            return (l = "radial"), e && r && ((e = i(e)), (r = i(r)), o(e - 0.5, 2) + o(r - 0.5, 2) > 0.25 && (r = n.sqrt(0.25 - o(e - 0.5, 2)) * (2 * (r > 0.5) - 1) + 0.5), (h = e + c + r)), f;
                                        })).split(/\s*\-\s*/)),
                                        "linear" == l)
                                    ) {
                                        var u = a.shift();
                            ...
                            (T.prototype = A),
                                ...
                                (A.blur = function (e) {
                                    ...
                                    return (
                                        (i = i.replace(g, f)),
                                        0 != +e
                                            ? ((this.attrs.blur = e), (r.filter = i + c + " progid:DXImageTransform.Microsoft.Blur(pixelradius=" + (+e || 1.5) + ")"), (r.margin = t.format("-{0}px 0 0 -{0}px", a(+e || 1.5))))
